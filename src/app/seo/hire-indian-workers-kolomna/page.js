...
export default function Page() {
    return (
        <SEOPageTemplate
            heroTitle="Найм работников из Индии в Коломне"
            heroDescription="Taha Airwaves предоставляет квалифицированных и неквалифицированных работников из Индии для бизнеса в Коломне. Мы специализируемся на поставке рабочей силы для строительного, промышленного и сервисного секторов."
            ...
            internalLinks={getLinksExcluding("/seo/hire-indian-workers-kolomna")}
        />
    )
}
