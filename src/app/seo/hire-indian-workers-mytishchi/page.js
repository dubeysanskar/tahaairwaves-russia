...
export default function Page() {
    return (
        <SEOPageTemplate
            heroTitle="Найм работников из Индии в Мытищах"
            heroDescription="Taha Airwaves предоставляет квалифицированных и неквалифицированных работников из Индии для бизнеса в Мытищах. Мы специализируемся на поставке рабочей силы для строительного, промышленного и сервисного секторов."
            ...
            internalLinks={getLinksExcluding("/seo/hire-indian-workers-mytishchi")}
        />
    )
}
